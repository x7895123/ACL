...
**Обязательное страхование ГПО перевозчика (ВТ) — 18 февраля 2026 г.**
...
7. ПРИМЕНЕНИЕ ТЕОРИИ ДОСТОВЕРНОСТИ (МОДЕЛЬ БЮЛЬМАНА)
      7.1. Обоснование применения распределения Пуассона
      7.2-7.4. Модель Бюльмана, оценка и интерпретация
8. РАСЧЁТ БАЗОВОЙ НЕТТО-СТАВКИ И БРУТТО-СТАВКИ
      8.1. Структура страховой премии (нетто и брутто)
      8.2. Описание параметров нетто-ставки
      8.3. Обоснование нагрузочных коэффициентов
      8.4. Актуарные допущения
      8.5. Полный расчёт нетто-ставки
9. ТЕСТИРОВАНИЕ АДЕКВАТНОСТИ ПРЕДЛОЖЕННЫХ ТАРИФОВ
      9.1–9.4. PML-тест, Combined Ratio, Non-Excessiveness, согласованность
      9.5. Коэффициент покрытия как рисковая поправка: ограничение VaR 99,5%
...
Настоящее заключение подготовлено квалифицированным актуарием в соответствии с требованиями Международной актуарной ассоциации (IAA), принципами CAS (Casualty Actuarial Society) и национальными стандартами актуарной деятельности Республики Казахстан.
